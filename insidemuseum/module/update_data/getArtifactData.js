...
module.exports = {
    getArtifactsList: async function (word_ja) {
        ...
        for (let number_of_page = 1; number_of_page < 200; number_of_page++) {
            await axios({
                method: 'get',
                url: "https://colbase.nich.go.jp/colbaseapi/v2/collection_items?locale=ja&page="
                    + number_of_page
                    + "&limit=100&with_image_file=1&only_parent=0&organization_id=4",

...
import pandas
import json
from save_model import save_class_to_json, save_model_tflite
import cv2
...
if __name__ == '__main__':
    ...
    MUSEUM_NAME = 'kyohaku'
    MUSEUM_DIR = '../image/' + MUSEUM_NAME + '_data/'
    IMG_SIZE = 224
    ...
    save_class_to_json(train_dataset.class_indices, MUSEUM_NAME)
